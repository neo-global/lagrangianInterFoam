...
{
  //  Info<<"In autoMap initial  globalPositionsPtr_.valid()" << bool(globalPositionsPtr_.valid())<<endl;
    globalPositionsPtr_.reset(new vectorField(this->size()));
    Info<<"size: " << int(this->size()) << endl;
  ...
  //  Info<<"In autoMap after storeGlobPos globalPosiitionPtr_.valid()" << bool(globalPositionsPtr_.valid())<<endl;
...
void Foam::Cloud<ParticleType>::storeGlobalPositions() const
{
    ...
    //Info<<"In storeGlobalPositions initial globalPositionsPtr_.valid(): " << bool(globalPositionsPtr_.valid())<<endl;
    globalPositionsPtr_.reset(new vectorField(this->size()));
    ...
    //Info<<"In storeGlobalPositions initial globalPosiitionPtr_.valid(): " << bool(globalPositionsPtr_.valid())<<endl;
}
