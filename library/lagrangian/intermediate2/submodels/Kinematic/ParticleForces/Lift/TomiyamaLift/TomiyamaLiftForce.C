...
) const
{
    ...
    scalar fOrig = 0.00105*pow3(Eod) - 0.0159*sqr(Eod) - 0.0204*((Eod)) + 0.474;
    //Info<<"f: "<<f<<"\t fOriginal: "<<fOrig<<"\t fMin: "<<0.288*tanh(0.121*Re)<<endl;
//-RM
// see f above: -1*Eo has been introduced. check changes with +/- sign. JB showed that triggering lift does have effect.
